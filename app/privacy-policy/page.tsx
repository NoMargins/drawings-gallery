  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-100 via-green-50 to-yellow-100">
      <div className="container mx-auto py-8 px-4">
        <div className="mb-6">
          <Link href="/">
            <Button variant="outline" className="font-myFont border-green-200 text-green-700 flex items-center gap-2">
              <ArrowLeft className="font-myFont h-4 w-4" /> Повернутися на головну
            </Button>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border-2 border-green-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="font-myFont text-2xl md:text-3xl font-bold text-green-700">Політика конфіденційності</h1>
          </div>
          ...
          <div className="prose prose-green max-w-none">
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="font-myFont text-xl font-bold text-green-700">Загальні положення</h2>
              </div>
              <p className="font-myFont text-green-600">
                Ця Політика конфіденційності визначає, як ми збираємо, використовуємо, зберігаємо та захищаємо
                інформацію, отриману від учасників конкурсу «Шеврон для мого захисника». Ми серйозно ставимося до
                захисту ваших персональних даних і дотримуємося всіх відповідних законів про захист даних.
              </p>
            </div>

            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Які дані ми збираємо</h2>
              <p className="font-myFont text-green-600 mb-4">Для участі в конкурсі ми збираємо наступну інформацію:</p>
              <ul className="font-myFont list-disc pl-6 text-green-600 space-y-2">
                <li>Ім'я дитини</li>
                <li>Вік дитини</li>
            ...
            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Як ми використовуємо ваші дані</h2>
              <p className="font-myFont text-green-600 mb-4">Ми використовуємо зібрані дані для:</p>
              <ul className="font-myFont list-disc pl-6 text-green-600 space-y-2">
                <li>Організації та проведення конкурсу «Шеврон для мого захисника»</li>
            ...
            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Згода на обробку даних</h2>
              <p className="font-myFont text-green-600">
            ...
            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Зберігання та захист даних</h2>
              <p className="font-myFont text-green-600">
            ...
            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Ваші права</h2>
              <p className="font-myFont text-green-600 mb-4">Ви маєте право:</p>
              <ul className="font-myFont list-disc pl-6 text-green-600 space-y-2">
            ...
            <div className="mb-8">
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Зміни до Політики конфіденційності</h2>
              <p className="font-myFont text-green-600">
            ...
            <div>
              <h2 className="font-myFont text-xl font-bold text-green-700 mb-2">Контактна інформація</h2>
              <p className="font-myFont text-green-600">
                Якщо у вас є питання щодо цієї Політики конфіденційності або обробки ваших персональних даних, будь
                ласка, зв'яжіться з нами за адресою: digest@fozzy.ua.
              </p>
            </div>
          </div>

          <div className="mt-8 pt-6 border-t border-green-100 text-center">
            <p className="font-myFont text-green-600">Останнє оновлення: {new Date().toLocaleDateString("uk-UA")}</p>
          </div>
        </div>
      </div>
    </div>
